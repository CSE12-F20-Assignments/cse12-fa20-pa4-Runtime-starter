...
# PA4: Runtime, Measured and Modeled (open)
---
...
This PA is due on ** **Wednesday, November 4 at 11:59pm** **
...
`LinkedStringList.java`, which are the starter files
from PA2.
...
- `measure` should work as follows:
  ...
  code](https://github.com/ucsd-cse12-f20/ucsd-cse12-f20.github.io/tree/master/discussion/Week4))
